            ...
            <div className="max-w-4xl  mx-auto text-white">
              ...
              <div className="flex flex-col md:flex-row flex-1 items-center">
                ...
                <p className="flex-1 ml-0 mt-10 md:mt-0 md:ml-10 opacity-80 font-light drop-shadow-md">
                  Olá, me chamo Cláudio Vitor Dantas e atualmente curso Sistemas
                  de Informação. Eu descobri a programação Web a pouco mais de
                  um ano e meio, e foi aí que me dei conta da área da
                  programação que gostaria de seguir. Meus estudos estão
                  voltados mais para a parte do Front-End, utilizando
                  tecnologias como React, Next.js, TailWind CSS, etc. Neste site
                  você encontrará as principais tecnologias que utilizo em meus
                  projetos pessoais, além dos projetos em si e suas descrições.
                </p>
              </div>
            </div>
          </div>
