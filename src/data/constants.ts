...
export const projects: Project[] = [
  {
    id: "1",
    title: "Flex Visit",
    imageUrl: "/images/flexvisit.jpg",
    description: "Sistema de gerenciamento e agendamento de visitas. ",
    link: "https://github.com/CDInacio/flex-visit-web",
    stack: ["React", "TypeScript", "Node.js", "Express", "MongoDB"],
  },
  {
    id: "2",
    title: "Quitandas da Ana Mares",
    imageUrl: "/images/quitandas.png",
    description:
      "Landing page para uma microempreendedora do ramo de quitandas artesanais.",
    link: "https://quitandas-da-ana-mares-official.vercel.app/",
    stack: ["React", "TypeScript", "Node.js", "Express", "MongoDB"],
  },
  {
    id: "3",
    ...
    description:
      "Aplicação para consultar a previsão do tempo de qualquer cidade do mundo.",
    link: "https://previsoes-mu.vercel.app/",
    code: "https://github.com/CDInacio/weather-app",
    stack: ["React", "Tailwind CSS", "TypeScript", "OpenWeather API"],
  },
  {
    id: "4",
